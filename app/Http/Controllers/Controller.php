...
abstract class Controller extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->sections = ['B' => 'Bahagian B: Indek Kebolehan Bekerja ', 'C' => 'Bahagian C: Soal-selidik Kandungan Kerja', 'D' => 'Bahagian D: Impak Latihan Di Tempat Kerja', 'E' => 'Bahagian E: Soal-selidik Prestasi Kerja Individu', 'F' => 'Bahagian F: Skala Kemurungan Psikologikal Kessler 6 ', 'G' => 'Bahagian G: Skala Kemurungan CES-D', 'H' => 'Bahagian H: Instrumen Penilaian Kepenatan', 'I' => 'Bahagian I: Penilaian Anggota Keseluruhan Tubuh (REBA)', 'J' => 'Bahagian J: Soal-selidik Muskuloskeletel Nordic (NMQ)', 'K' => 'Bahagian K: Soal-selidik Analisis Kerja (JAQ)', 'L' => 'Bahagian L: Ujian Kecergasan BOMBA (UKTK/ UKB/ IPPT)'];
